...
bool detectCycle(Node *head)
{
    ...
    //dont write while (fast->next && fast && slow!=fast);
    //this will give runtime error if fast is NULL and you try to access its next 
...
//also study utility functions below and an efficient way to write code
class node {
    public:
        int num;
        node* next;
